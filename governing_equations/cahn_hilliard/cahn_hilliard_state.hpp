...
class CahnHilliardState3D : public SolutionState {
 public:
  using BaseType = ManagedArray3DNonOwning<real_wp>;

  CahnHilliardState3D(const ManagedArrayOwner& owner, const std::string& state_name, int ni, int nj, int nk, int nhalo)
