...
ExternalProject_Add(
        ...
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${EXTERNAL_INSTALL_DIR} -DENABLE_CUDA=${MADG_USE_CUDA} -DENABLE_OPENMP=${MADG_USE_OPENMP} -DCMAKE_CUDA_STANDARD=14 -DRAJA_ENABLE_TESTS=Off -DRAJA_ENABLE_EXAMPLES=Off -DRAJA_ENABLE_EXERCISES=Off -DCUDA_TOOLKIT_ROOT_DIR=${CUDA_TOOLKIT_ROOT_DIR}
)
